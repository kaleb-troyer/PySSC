...
class PySSC:
	def __init__(self):
		...
		sam_directory = "C:/source/.repositories/sam_dev/build/ssc/ssc/Debug"

		if sys.platform == 'win32' or sys.platform == 'cygwin':
			#print("Using SSC DLL from here: ", this_directory)
			self.pdll = CDLL(os.path.join(sam_directory, "sscd.dll"))
		elif sys.platform == 'darwin':
			self.pdll = CDLL(os.path.join(sam_directory, "libssc.so"))
